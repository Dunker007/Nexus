...
export const INITIAL_LABS_DATA = [
    ...
    { id: 'smarthome', icon: '🏠', name: 'Smart Home', desc: 'Home Assistant Dashboard.', status: 'concept' as const, category: 'Operations' as const, priority: 'Medium' as const, agents: ['bytebot'], href: '/smarthome', ideas: 0, timeline: { startMonth: 1, durationMonths: 6, progress: 45 }, owner: 'ByteBot' },
    ...
    { id: 'analytics', icon: '📊', name: 'Analytics Hub', desc: 'Performance dashboards.', status: 'active' as const, category: 'Intelligence' as const, priority: 'Medium' as const, agents: ['oracle'], href: '/analytics', ideas: 0, timeline: { startMonth: 2, durationMonths: 4, progress: 80 }, owner: 'Oracle' },
    { id: 'knowledge', icon: '🧠', name: 'Knowledge Base', desc: 'RAG & Vector Memory.', status: 'active' as const, category: 'Intelligence' as const, priority: 'High' as const, agents: ['architect'], href: '/knowledge', ideas: 0, timeline: { startMonth: 3, durationMonths: 6, progress: 70 }, owner: 'Architect' },
    { id: 'dataweave', icon: '🕸️', name: 'Data Weave', desc: 'ETL Pipelines.', status: 'active' as const, category: 'Intelligence' as const, priority: 'High' as const, agents: ['oracle'], href: '/dataweave', ideas: 0, timeline: { startMonth: 3, durationMonths: 6, progress: 70 }, owner: 'Oracle' },
