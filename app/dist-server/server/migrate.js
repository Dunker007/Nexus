...
const migrateData = newDb.transaction(() => {
    try {
        ...
        console.log('⚠️ Could not migrate ChatMessage:', e.message);
    }
    try {
        // 2. Migrate Agents
        ...
        console.log('⚠️ Could not migrate Agents:', e.message);
    }
    try {
        // 3. Migrate Pipeline
        ...
        console.log('⚠️ Could not migrate Pipeline Tracks:', e.message);
    }
});
migrateData();
