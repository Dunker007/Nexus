...
export function CardSkeleton() {
  return (
    <div className="glass-card p-6 border border-white/5 rounded-2xl bg-white/[0.02]">
...
export function StatsSkeleton() {
  return (
    <div className="grid grid-cols-3 gap-4">
      {[1, 2, 3].map(i => (
        <div key={i} className="text-center p-3 bg-white/5 rounded-lg border border-white/5">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-void)]">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-500 text-sm font-black uppercase tracking-widest animate-pulse">Synchronizing Interface...</p>
      </div>
    </div>
  );
}
