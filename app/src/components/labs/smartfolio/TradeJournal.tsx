...
import type { JournalEntry } from '@/lib/smartfolio/store/portfolio';
...
export default function TradeJournal() {
    ...
    const confirmImport = () => {
        ...
        const addedCount = previewItems.filter(i => !i.isDuplicate).length;
        const skippedCount = previewItems.filter(i => i.isDuplicate).length;
        alert(`Import Complete:\n• ${addedCount} new entries added.\n• ${skippedCount} duplicates identified and skipped.`);
        setImportText('');
